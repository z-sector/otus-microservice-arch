...
import (
	...
	"github.com/wuzyk/otus-microservice-arch/06/internal/handlers"
	"github.com/wuzyk/otus-microservice-arch/06/internal/logger"
	"github.com/wuzyk/otus-microservice-arch/06/internal/repo"
	"github.com/wuzyk/otus-microservice-arch/06/internal/server"
)
...
func main() {
	...
	handlers := &server.Handlers{
		...
		Order:       handlers.NewOrderHandler(orderRepo),
	}
